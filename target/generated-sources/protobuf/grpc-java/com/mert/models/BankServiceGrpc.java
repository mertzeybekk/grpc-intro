...
public final class BankServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.mert.models.BalanceCheckRequest,
      com.mert.models.Balance> getGetBalanceMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "getBalance",
      requestType = com.mert.models.BalanceCheckRequest.class,
      responseType = com.mert.models.Balance.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.mert.models.BalanceCheckRequest,
      com.mert.models.Balance> getGetBalanceMethod() {
    io.grpc.MethodDescriptor<com.mert.models.BalanceCheckRequest, com.mert.models.Balance> getGetBalanceMethod;
      ...
      synchronized (BankServiceGrpc.class) {
        if ((getGetBalanceMethod = BankServiceGrpc.getGetBalanceMethod) == null) {
          BankServiceGrpc.getGetBalanceMethod = getGetBalanceMethod =
              io.grpc.MethodDescriptor.<com.mert.models.BalanceCheckRequest, com.mert.models.Balance>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "getBalance"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.mert.models.BalanceCheckRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.mert.models.Balance.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.mert.models.WithdrawRequest,
      com.mert.models.Money> getWithdrawMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "withdraw",
      requestType = com.mert.models.WithdrawRequest.class,
      responseType = com.mert.models.Money.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<com.mert.models.WithdrawRequest,
      com.mert.models.Money> getWithdrawMethod() {
    io.grpc.MethodDescriptor<com.mert.models.WithdrawRequest, com.mert.models.Money> getWithdrawMethod;
    if ((getWithdrawMethod = BankServiceGrpc.getWithdrawMethod) == null) {
      synchronized (BankServiceGrpc.class) {
        if ((getWithdrawMethod = BankServiceGrpc.getWithdrawMethod) == null) {
          BankServiceGrpc.getWithdrawMethod = getWithdrawMethod =
              io.grpc.MethodDescriptor.<com.mert.models.WithdrawRequest, com.mert.models.Money>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "withdraw"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.mert.models.WithdrawRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.mert.models.Money.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.mert.models.DepositRequest,
      com.mert.models.Balance> getCashDepositMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "cashDeposit",
      requestType = com.mert.models.DepositRequest.class,
      responseType = com.mert.models.Balance.class,
      methodType = io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
  public static io.grpc.MethodDescriptor<com.mert.models.DepositRequest,
      com.mert.models.Balance> getCashDepositMethod() {
    io.grpc.MethodDescriptor<com.mert.models.DepositRequest, com.mert.models.Balance> getCashDepositMethod;
      ...
      synchronized (BankServiceGrpc.class) {
        if ((getCashDepositMethod = BankServiceGrpc.getCashDepositMethod) == null) {
          BankServiceGrpc.getCashDepositMethod = getCashDepositMethod =
              io.grpc.MethodDescriptor.<com.mert.models.DepositRequest, com.mert.models.Balance>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "cashDeposit"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.mert.models.DepositRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.mert.models.Balance.getDefaultInstance()))
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void getBalance(com.mert.models.BalanceCheckRequest request,
        io.grpc.stub.StreamObserver<com.mert.models.Balance> responseObserver) {
     ...
     * </pre>
     */
    default void withdraw(com.mert.models.WithdrawRequest request,
        io.grpc.stub.StreamObserver<com.mert.models.Money> responseObserver) {
     ...
     * </pre>
     */
    default io.grpc.stub.StreamObserver<com.mert.models.DepositRequest> cashDeposit(
        io.grpc.stub.StreamObserver<com.mert.models.Balance> responseObserver) {
  ...
  public static final class BankServiceStub
     ...
     * </pre>
     */
    public void getBalance(com.mert.models.BalanceCheckRequest request,
        io.grpc.stub.StreamObserver<com.mert.models.Balance> responseObserver) {
     ...
     * </pre>
     */
    public void withdraw(com.mert.models.WithdrawRequest request,
        io.grpc.stub.StreamObserver<com.mert.models.Money> responseObserver) {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<com.mert.models.DepositRequest> cashDeposit(
        io.grpc.stub.StreamObserver<com.mert.models.Balance> responseObserver) {
  ...
  public static final class BankServiceBlockingStub
     ...
     * </pre>
     */
    public com.mert.models.Balance getBalance(com.mert.models.BalanceCheckRequest request) {
     ...
     * </pre>
     */
    public java.util.Iterator<com.mert.models.Money> withdraw(
        com.mert.models.WithdrawRequest request) {
  ...
  public static final class BankServiceFutureStub
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.mert.models.Balance> getBalance(
        com.mert.models.BalanceCheckRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_BALANCE:
          serviceImpl.getBalance((com.mert.models.BalanceCheckRequest) request,
              (io.grpc.stub.StreamObserver<com.mert.models.Balance>) responseObserver);
          break;
        case METHODID_WITHDRAW:
          serviceImpl.withdraw((com.mert.models.WithdrawRequest) request,
              (io.grpc.stub.StreamObserver<com.mert.models.Money>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.mert.models.BalanceCheckRequest,
              com.mert.models.Balance>(
                service, METHODID_GET_BALANCE)))
        .addMethod(
          getWithdrawMethod(),
          io.grpc.stub.ServerCalls.asyncServerStreamingCall(
            new MethodHandlers<
              com.mert.models.WithdrawRequest,
              com.mert.models.Money>(
                service, METHODID_WITHDRAW)))
        .addMethod(
          getCashDepositMethod(),
          io.grpc.stub.ServerCalls.asyncClientStreamingCall(
            new MethodHandlers<
              com.mert.models.DepositRequest,
              com.mert.models.Balance>(
  ...
  private static abstract class BankServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.mert.models.BankServiceOuterClass.getDescriptor();
    }
