...
public final class TransferServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.mert.models.TransferRequest,
      com.mert.models.TransferResponse> getTransferMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "transfer",
      requestType = com.mert.models.TransferRequest.class,
      responseType = com.mert.models.TransferResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<com.mert.models.TransferRequest,
      com.mert.models.TransferResponse> getTransferMethod() {
    io.grpc.MethodDescriptor<com.mert.models.TransferRequest, com.mert.models.TransferResponse> getTransferMethod;
      ...
      synchronized (TransferServiceGrpc.class) {
        if ((getTransferMethod = TransferServiceGrpc.getTransferMethod) == null) {
          TransferServiceGrpc.getTransferMethod = getTransferMethod =
              io.grpc.MethodDescriptor.<com.mert.models.TransferRequest, com.mert.models.TransferResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "transfer"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.mert.models.TransferRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.mert.models.TransferResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default io.grpc.stub.StreamObserver<com.mert.models.TransferRequest> transfer(
        io.grpc.stub.StreamObserver<com.mert.models.TransferResponse> responseObserver) {
  ...
  public static final class TransferServiceStub
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<com.mert.models.TransferRequest> transfer(
        io.grpc.stub.StreamObserver<com.mert.models.TransferResponse> responseObserver) {
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncBidiStreamingCall(
            new MethodHandlers<
              com.mert.models.TransferRequest,
              com.mert.models.TransferResponse>(
  ...
  private static abstract class TransferServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.mert.models.TransferServiceOuterClass.getDescriptor();
    }
